...
# Menu Table 
def insert_bus_line():
    with open('data/humphreys/bus_line_data.csv', newline='', encoding='utf8') as csvfile:
...
def insert_bus_stop():
    with open('data/humphreys/bus_stop_data.csv', newline='', encoding='utf8') as csvfile:
        data_reader = csv.reader(csvfile)
...
def insert_bus_stop_line():    
    with open('data/humphreys/bus_stop_line_data.csv', newline='', encoding='utf8') as csvfile:
        data_reader = csv.reader(csvfile)
...
def insert_bus_stop_time():    
    with open('data/humphreys/bus_stop_time_data.csv', newline='', encoding='utf8') as csvfile:
        data_reader = csv.reader(csvfile)
        for row in data_reader:
